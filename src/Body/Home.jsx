    ...
    <section>
          ...
          <div className="flex justify-center items-center flex-col gap-5">
            ...
            <div className="flex justify-center items-center">
              <p className=" font-[times-new-roman] w-[55vw] text-3xl  text-center">
                ...
                planners, providing a seamless,efficient, and tailored approach
                to creating extraordinary events.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="wedo">
        ...
        <div className="w-[100%] flex items-center justify-around gap-5">
          <p className="w-[30vw]  font-[times-new-roman] text-justify leading-10 text-xl pl-5">
            ...
            finding the perfect team to organizing every detail, we provide the
            tools and resources to make every event seamless, stress-free, and
            unforgettable.
          </p>
          <img
            src="src/assets/Images/IMAGE2.jpg"
            alt=""
            className="h-[80vh] w-[50vw] flex items-center justify-center"
          />
        </div>
      </section>
      ...
      <section className="h-[100vh] w-[100%] flex items-center justify-center">
        <div className="flex justify-around items-center w-[100%] h-[100vh]">
          ...
          <div>
            <h1 className="text-4xl font-[times-new-roman] text-center font-bold">
              ABOUT US
            </h1>
            <div>
              <p className="w-[30vw] leading-10  font-[times-new-roman] text-justify mt-10 text-xl">
                At <span className="font-bold">Event Haven</span>, we bridge the
                gap between event enthusiasts, Professional planners, and
                trusted vendors.Our platform empowers clients to discover and
                attend events, helps planners showcase their skills and manage
                projects efficiently, and connects vendors to new business
                opportunities. From seamless ticketing to end-to-end event
                creation, we're here to make every occasion extraordinary.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="weoffer">
        ...
        <div className="flex justify-center gap-5">
          <div className=" shadow-sm shadow-[gray] h-[35vh] bg-white w-[25vw] rounded-md flex items-center justify-center flex-col">
            ...
            <div>
              <p className="font-[times-new-roman] mt-5 text-center p-3">
                ...
                corporate event, we provide tools and resources to make every
                step effortless{" "}
              </p>
            </div>
          </div>
          ...
          <div className=" shadow-sm shadow-[gray] h-[35vh] bg-white w-[25vw] rounded-md flex items-center justify-center flex-col">
            ...
            <div>
              <p className="font-[times-new-roman] mt-5 text-center p-3">
                Tailor your event experience with customizable planning
                features, including budgeting scheduling, and guest management.
              </p>
            </div>
          </div>

          <div className=" shadow-sm shadow-[gray] h-[35vh] bg-white w-[25vw] rounded-md flex items-center justify-center flex-col">
            <h3 className="text-xl font-[times-new-roman] font-bold  text-center w-[20vw]">
          ...
          <div className=" shadow-lg shadow-[gray] h-[55vh] w-[30vw] rounded-md flex items-center justify-center flex-col">
            ...
            <div>
              ...
              <p className="font-[times-new-roman] text-center p-3 leading-7">
                Discover a world of events tailored to your interests-whether
                it's concerts, weddings, ortech conferences. book tickets, stay
          ...
          <div className=" shadow-lg shadow-[gray] h-[55vh] w-[30vw] rounded-md flex items-center justify-center flex-col">
            ...
            <div>
              ...
              <p className="font-[times-new-roman] text-center p-3 leading-7">
                ...
                skills. Use our tools to manage projects, coordinate with
                vendors, and streamline every detail of your event
                planningprocess.Grow your business while we help you find new
                Opportunities!
              </p>
            </div>
          </div>
          <div className=" shadow-lg shadow-[gray] h-[55vh] w-[30vw] gap-8 rounded-md flex items-center justify-center flex-col">
            <h1 className="text-2xl font-[times-new-roman] font-bold  flex items-center justify-center w-[16vw]">
              VENDORS
            </h1>
            <div>
              <p className="font-[times-new-roman]  font-bold ">
              ...
              <p className="font-[times-new-roman] text-center w-[25vw] flex items-center justify-center leading-7">
                ...
                decorations, venues, and more. Collaborate with event planners
                and clients to turn their visions into reality, and expand your
      ...
      {/* TESTIMONIALS */}
      <section
        className="flex items-center bg-cover bg-center flex-col justify-center h-[89vh] bg-gray-100"
        style={{ backgroundImage: `url('${Phone}')` }}
      >
        <h1 className="text-3xl font-[times-new-roman] text-center mb-10 text-white font-bold">
          TESTIMONIALS
        </h1>
        <div className="flex gap-3 mt-10 ">
          <div className=" shadow-lg bg-white shadow-[gray] h-[50vh] w-[23vw] rounded-md flex items-center justify-center flex-col gap-2">
            <p className="font-[times-new-roman] text-center text-balance w-[21vw]">
              ...
              platform. from finding the perfect planner to coordinating
              vendors, everything was seamless. Highly recommend!"
            </p>
          ...
          <div className="shadow-lg bg-white shadow-[gray] h-[50vh] w-[23vw] rounded-md flex items-center justify-center flex-col gap-2">
            <p className="font-[times-new-roman] text-center w-[21vw]">
              "Being part of this platform has been a game changer for my
              catering business. I have gained exposure to so many events i
              wouldnt have reached otherwise."
            </p>
            <div className="flex text-yellow-500 justify-center items-center">
              <i>
                <RiStarFill />
      ...
      {/* CONTACT US */}
      <section className="h-[70vh] mt-10 bg-[#394457] font-[times-new-roman] cursor-pointer">
